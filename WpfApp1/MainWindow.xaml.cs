...
namespace inputValidation
{
    public partial class MainWindow : Window
    {
        ...
        // phone check
        private bool _checkPhone(string phone)
        {
        ...
        // pasport check
        private bool _checkPasport(string pasport)
        {
        ...
        // identity check
        private bool _checkID(string id)
        {
        ...
        private bool _checkNSP(string name, string surname, string patronymic)
        {
